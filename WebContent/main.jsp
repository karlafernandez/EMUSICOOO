                ...
                $.ajax({
                    ...
                    error: function(jqXHR, textStatus, errorThrown){
                         console.log("Something really bad happened " + textStatus);
                          $("#ajaxResultCanciones").html(jqXHR.responseText);
                    },
...
<div class="wrap">
		...
		<div class="header_top">
		 	<div class="header_top_right">
			 	<div class="search_box">
				    <form id="frmSearch" action = "CtrlBuscar" method="post">
				    	<input type="text" name="buscar" value="Search lyrics" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search Lyrics';}">
			    ...
			    <div class="drp-dwn">
				 	<select id="cmbArtistas">
						...
						<option value="">Stratovarius</option>
						<option value="">Sirenia</option>
						<option value="">Loquillo y los trogloditas</option>
						<option value="">Paramore</option>
						<option value="">Adele</option>
						<option value="">Plan B</option>
						<option value="">Dolores delirio</option>
						<option value="">Glut</option>
						<option value="">Rio roma</option>					
					</select>
			    </div>
				<div class="drp-dwn">
	...
	<div class = "header_bottom_left">
		<div id="resultCanciones">
			<div class="content">
				<h2>Resultados:</h2>
	    		<fieldset> <div id="ajaxResultCanciones"></div> </fieldset>
	    	</div>				
	   	</div>
   </div>
	 ...
	 <div class="header_bottom_right_images">
		    <div id="slideshow">
					<ul class="slides">
				        <li><canvas></canvas><img src="images/2.jpg" alt="Turrimetta Beach - Dawn" ></li>
				    	<li><canvas ></canvas><img src="images/1.jpg" alt="Marsa Alam underawter close up" ></li>
				        <li><canvas></canvas><img src="images/3.jpg" alt="Power Station" ></li>
				    </ul>
