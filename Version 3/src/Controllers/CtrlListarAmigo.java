...
/**
 * Servlet implementation class CtrlListarAmigo
 */
@WebServlet("/CtrlListarAmigo")
public class CtrlListarAmigo extends HttpServlet {
	private static final long serialVersionUID = 1L;
    private Amigo m_amigo;   
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CtrlListarAmigo() {
        super();
